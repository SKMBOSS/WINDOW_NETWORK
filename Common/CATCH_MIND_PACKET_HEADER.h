...
enum PACKET_INDEX
{
	...
	PACKET_INDEX_SEND_START_BUTTON_CLICK,
	PACKET_INDEX_SEND_GAME_READY_TRUE,
	PACKET_INDEX_SEND_GAME_READY_FALSE,
	PACKET_INDEX_SEND_USER_READY_BOX,
	PACKET_INDEX_SEND_HOST_PAINTING
};
...
struct PACKET_SEND_START_BUTTON_CLICK
{
	PACKET_HEADER	header;
};
...
struct PACKET_SEND_USER_READY_BOX
{
	PACKET_HEADER	header;
	int				userNum;
	bool			userReady[8];
...
struct PACKET_SEND_HOST_PAINTING
{
	PACKET_HEADER	header;
};
